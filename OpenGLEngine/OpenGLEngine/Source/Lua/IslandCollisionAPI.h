...
public:
	...
	static bool IslandCollisionAPI::DoesCollisionOccur(LuaRef thisbox, LuaRef manyList, int listSize);

	static int IslandCollisionAPI::GetCollisionIndex(LuaRef thisbox, LuaRef manyList, int listSize);
