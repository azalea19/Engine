...
function initMenu()
    ...
    local newPos = {x=10,y=1,z=20}
    local newDir = {x=0,y=1,z=0}
    ButtonOne = gameObject.new("ButtonOne", "ButtonOne", "btnBack", newPos, newDir, newScale, newAnim)
    ...
    local newPos = {x=0,y=1,z=20}
    local newDir = {x=0,y=1,z=0}
    ButtonThree = gameObject.new("ButtonThree", "ButtonThree", "btnBack", newPos, newDir, newScale, newAnim)
